...
public class Arco {
    ...
    public Arco(){
        ...
        ImageIcon arco_de_acao = new ImageIcon("C:/Users/jarde/OneDrive/Documentos/GitHub/Archery_Simulator/Archery_Simulator/src/MainJogo/arco.png");
        imagem_acao = arco_de_acao.getImage();

        ImageIcon arco_solto = new ImageIcon("C:/Users/jarde/OneDrive/Documentos/GitHub/Archery_Simulator/Archery_Simulator/src/MainJogo/arco.png");
        imagem1 = arco_solto.getImage();

        ImageIcon arco_solto_cima = new ImageIcon("C:/Users/jarde/OneDrive/Documentos/GitHub/Archery_Simulator/Archery_Simulator/src/MainJogo/arco_cima.png");
        imagem1_cima = arco_solto_cima.getImage();

        ImageIcon arco_puxado = new ImageIcon("C:/Users/jarde/OneDrive/Documentos/GitHub/Archery_Simulator/Archery_Simulator/src/MainJogo/arco_puxado.png");
        imagem2 = arco_puxado.getImage();

        ImageIcon arco_puxado_cima = new ImageIcon("C:/Users/jarde/OneDrive/Documentos/GitHub/Archery_Simulator/Archery_Simulator/src/MainJogo/arco_puxado_cima.png");
