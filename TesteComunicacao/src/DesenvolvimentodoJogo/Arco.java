...
public class Arco {
    ...
    private double contador_forca = 0;
    private double contador_pressionado = 0;
    private double contador_cima = 0;
    private double contador_pressionado_cima = 0;
    ...
    public Arco(){
        ...
        ImageIcon arco_de_acao = new ImageIcon("C:\\Users\\jarde\\OneDrive\\Documentos\\GitHub\\Archery_Simulator\\TesteComunicacao\\src\\DesenvolvimentodoJogo\\images\\arco.png");
        imagem_acao = arco_de_acao.getImage();

        ImageIcon arco_solto = new ImageIcon("C:\\Users\\jarde\\OneDrive\\Documentos\\GitHub\\Archery_Simulator\\TesteComunicacao\\src\\DesenvolvimentodoJogo\\images\\arco.png");
        imagem1 = arco_solto.getImage();

        ImageIcon arco_solto_cima = new ImageIcon("C:\\Users\\jarde\\OneDrive\\Documentos\\GitHub\\Archery_Simulator\\TesteComunicacao\\src\\DesenvolvimentodoJogo\\images\\arco_cima.png");
        imagem1_cima = arco_solto_cima.getImage();

        ImageIcon arco_puxado = new ImageIcon("C:\\Users\\jarde\\OneDrive\\Documentos\\GitHub\\Archery_Simulator\\TesteComunicacao\\src\\DesenvolvimentodoJogo\\images\\arco_puxado.png");
        imagem2 = arco_puxado.getImage();

        ImageIcon arco_puxado_cima = new ImageIcon("C:\\Users\\jarde\\OneDrive\\Documentos\\GitHub\\Archery_Simulator\\TesteComunicacao\\src\\DesenvolvimentodoJogo\\images\\arco_puxado_cima.png");
